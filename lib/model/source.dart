...
class Source extends StripeJsonModel implements StripePaymentSource {
  ...
  int ? amount;
  String ?clientSecret;
 late SourceCodeVerification codeVerification;
  int ?created;
  String ?currency;
  late String typeRaw;
  String ? flow;
  ...
  late SourceOwner owner;
  late SourceReceiver receiver;
  late SourceRedirect redirect;
  String? status;
  late Map<String, Object> sourceTypeData;
