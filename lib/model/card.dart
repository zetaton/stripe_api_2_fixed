...
class StripeCard extends StripeJsonModel implements StripePaymentSource {
  ...
  static const int cvcLengthAmericanExpress = 4;
  static const int cvcLengthCommon = 3;

  static const String fundingCredit = "credit";
  static const String fundingDebit = "debit";
  static const String fundingPrepaid = "prepaid";
  static const String fundingUnknown = "unknown";
  ...
  bool validateCVC() {
    ...
    bool validLength =
        (updatedType == null && cvcValue.length >= 3 && cvcValue.length <= 4) ||
            (americanExpress == updatedType && cvcValue.length == 4) ||
            cvcValue.length == 3;
  ...
  static String? asFundingType(String? possibleFundingType) {
    ...
    if (StripeCard.fundingCredit == possibleFundingType) {
      return StripeCard.fundingCredit;
    } else if (StripeCard.fundingDebit == possibleFundingType) {
      return StripeCard.fundingDebit;
    } else if (StripeCard.fundingPrepaid == possibleFundingType) {
      return StripeCard.fundingPrepaid;
    } else {
      return StripeCard.fundingUnknown;
    }
  }
}
