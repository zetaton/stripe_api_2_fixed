import 'package:stripe_api_2/model/source_receiver.dart';
...
class CustomerSource extends StripeJsonModel implements StripePaymentSource {
  late StripePaymentSource stripePaymentSource;

   CustomerSource.fromJson(Map<String, dynamic> json) {
    ...
    CustomerSource._internal(sourceObject!);
  }
